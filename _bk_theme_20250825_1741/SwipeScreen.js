  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#0b1020", paddingTop: 56, paddingHorizontal: 16 }}>
      ...
      <View style={{ position: "absolute", top: 12, right: 12, backgroundColor: "#263859", paddingVertical: 6, paddingHorizontal: 10, borderRadius: 10 }}>
        <Text style={{ color: "#fff", fontWeight: "800" }}>{t(lang,"likes_heart")} {likedCount}</Text>
      </View>
      ...
      <Swiper
        ...
        overlayLabels={{
          left:  { title: t(lang,"no_label"),   style: { label: { color: "#ff6b6b", fontSize: 32, fontWeight: "800" } } },
          right: { title: t(lang,"like_label"), style: { label: { color: "#4cd137", fontSize: 32, fontWeight: "800" } } }
        }}
        renderCard={(card) => {
          ...
          return (
            <View style={{ flex: 1, borderRadius: 16, backgroundColor: "#1b2340", padding: 20, justifyContent: "center" }}>
              ...
              <Text style={{ color: "#cfd8dc" }}>{card.gender === "M" ? t(lang,"male") : t(lang,"female")}  {card.age}</Text>
