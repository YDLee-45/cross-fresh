...
function Chip({ label, active, onPress, c }) {
  return (
    <Pressable onPress={onPress}
      style={{ backgroundColor: active ? c.primary : c.muted, paddingVertical:10, paddingHorizontal:14, borderRadius:12, marginRight:8 }}>
  ...
  return (
    <View style={{ marginBottom:16 }}>
      ...
      <View style={{ flexDirection:"row" }}>
        <Pressable onPress={dec} style={{ backgroundColor:c.muted, padding:10, borderRadius:10, marginRight:8 }}>
          <Text style={{ color:"#fff", fontWeight:"800" }}>-</Text>
        </Pressable>
        <Pressable onPress={inc} style={{ backgroundColor:c.muted, padding:10, borderRadius:10 }}>
          <Text style={{ color:"#fff", fontWeight:"800" }}>+</Text>
        </Pressable>
      </View>
    </View>
